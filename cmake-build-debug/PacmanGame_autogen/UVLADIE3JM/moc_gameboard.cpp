...
void GameBoard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->gameOver((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 3: _t->updateGame(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (GameBoard::*)(int )>(_a, &GameBoard::scoreChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (GameBoard::*)(int )>(_a, &GameBoard::livesChanged, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (GameBoard::*)(bool )>(_a, &GameBoard::gameOver, 2))
            return;
    }
}
...
// SIGNAL 1
void GameBoard::livesChanged(int _t1)
{
